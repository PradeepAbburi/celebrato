    ...
    <header className="sticky top-0 z-40 w-full bg-[#202020]/90 backdrop-blur-md border-b border-[#383838]">
      ...
      {mobileMenuOpen && (
        <div id="nav-mobile-drawer" className="md:hidden px-4 pt-2 pb-6 bg-[#202020] border-b border-[#383838] space-y-3">
          ...
          {/* Authentication Actions in Hamburger Menu */}
          {!currentUser ? (
            <div className="pt-3 border-t border-[#333] space-y-2">
              <button
                ...
                className="w-full py-2.5 px-4 text-center text-sm font-bold rounded-xl bg-[#282828] hover:bg-[#323232] text-white border border-[#3e3e3e] flex items-center justify-center gap-2 transition active:scale-98"
              >
              ...
              <button
                ...
                className="w-full py-2.5 px-4 text-center text-sm font-bold rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-slate-950 shadow-lg shadow-amber-500/20 flex items-center justify-center gap-2 transition active:scale-98"
              >
            ...
            <div className="pt-3 border-t border-[#333] flex items-center justify-between px-1">
              <div className="flex items-center gap-2">
                ...
                <div className="text-xs">
                  <div className="font-semibold text-white truncate max-w-[150px]">{profile?.displayName || 'Party Host'}</div>
                  <div className="text-gray-400 truncate max-w-[150px] text-[11px]">{currentUser.email}</div>
                </div>
              </div>
              <button
                ...
                className="text-xs text-rose-400 hover:text-rose-300 font-semibold px-2.5 py-1.5 rounded-lg bg-rose-500/10 hover:bg-rose-500/20 transition flex items-center gap-1"
              >
